...
const HSM_SEED: u64 = 0x1002; // Unique seed for boot-time HSM
...
async fn main() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    let firmware_code = b"WHEEL_FR_FIRMWARE_v1.0.0";
    ...
    loop {
        ...
        // Slightly different noise phase than FL
        ...
        match hsm_client
            .create_secured_frame(can_ids::WHEEL_SPEED_FR, data.to_vec())
            .await
        {
            Ok(secured_frame) => {
